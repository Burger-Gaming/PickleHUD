...
textBorderHasColor = true
underlayHasColor = true
...
iconPath = 'PickleHUD/icon'
iconBorderPath = 'PickleHUD/iconBorder'
...
textY = 670
scoreTextY = 677
ratingTextY = textY - 90
versionTextY = iconY - 20
thingy = "Sick: 0\nGood: 0\nBad: 0\nShit: 0"
version = '1.0.0'
...
function onCreatePost()
	...
	makeLuaText('songNameLol', songName .. " - " .. difficultyName, 0, getProperty('healthBar.x') - 2, songNameY)
